...
function getEnvData(){
	...
	$.ajax({
		...
		url:"<%=request.getContextPath()%>/pointData/getEnvironmentInfo.action",
		success:function(data){
			EnvData=data;
	    },
	    error:function(data){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td background="<%=request.getContextPath()%>/images/menu_04.gif"><table width="600" border="0" align="right" cellpadding="0" cellspacing="0">
      <tr class="w01">
