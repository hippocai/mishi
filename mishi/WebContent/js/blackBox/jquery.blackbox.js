...
(function () {
    ...
    BlackBox.fn.prompt = function (text, callback, options, _delay_appear) {
        ...
        var backVal = "";
        if($("#BlackBox_backVal").length > 0){
        	backVal = $("#BlackBox_backVal").val();
        }
        
        $BlackBox.append('<div class = "system Inner" id="prompt' + _getNowID.call(this) + '"><p>' + args[0] + '</p><input id="boxInput" value="'+backVal+'"></div>');
